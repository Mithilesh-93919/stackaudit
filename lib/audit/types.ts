...
export type AuditResult = {
  ...
  summary: string;
  /**
   * True when the summary was generated by Claude (Anthropic API).
   * False when the deterministic template fallback was used.
   * Optional for backwards compatibility with persisted JSONB results.
   */
